...
class FourAspectFitRenderer : BasePageRenderer {
    ...
    override fun renderContent(
        ...
        renderImage(document, contentStream, imageTopLeft.loadImage(), ImageRenderMode.ASPECT_FIT, imageTopLeft.alignment,
        ...
        renderImage(document, contentStream, imageTopRight.loadImage(), ImageRenderMode.ASPECT_FIT, imageTopRight.alignment,
        ...
        renderImage(document, contentStream, imageBottomLeft.loadImage(), ImageRenderMode.ASPECT_FIT, imageBottomLeft.alignment,
        ...
        renderImage(document, contentStream, imageBottomRight.loadImage(), ImageRenderMode.ASPECT_FIT, imageBottomRight.alignment,
